                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                          ...
                          title: Text("Upload Course Policy",style: TextStyle(color: AppColors.theme['black'],fontWeight: FontWeight.bold,fontSize: 20),),
                          content: Column(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Text("Please provide the Google Drive link for the course policy.",style: TextStyle(color: AppColors.theme['black'],fontWeight: FontWeight.bold),),
                              SizedBox(height: 20),
                              CustomTextField(hintText: "Google Drive Link", isNumber: false, obsecuretext: false,controller: linkController,),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          color:
              isSelected ? AppColors.theme['green'] : AppColors.theme['white'],
